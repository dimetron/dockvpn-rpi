# OpenVPN for Docker - for Raspberry PI

Based on original work of Jérôme Petazzoni https://github.com/jpetazzo/dockvpn
and Hypriot RPI Docker http://blog.hypriot.com
...
When the `dockvpn-rpi` image is started, it generates:
